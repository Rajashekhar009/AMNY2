  ...
  Bitmap downloadBitmap(String url) {
    ...
    try {
      ...
      if (statusCode != HttpStatus.SC_OK) {
        Log.w("Imageloader", "Error " + statusCode+ " while retrieving bitmap from " + url);
        return null;
      }
      else Log.d("ImageLoader", "Success " + statusCode+ " while retrieving bitmap from " + url);
