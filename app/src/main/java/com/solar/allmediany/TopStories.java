...
public class TopStories extends HeaderActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      private class MyTask extends AsyncTask<Void, Void, Void> {
              ...
              protected Void doInBackground(Void... args) {  
                 try {
                	 String URL = "http://allmediany.com/service/allmediany-service.svc/getTopStoryList/format=json/";	 
                	 int n=0;
         			...
         			if(n>0)
         			 ...
         			 for (int i = 0; i < n; i++) {         				
         				...
         				JSONObject c 	= ja.getJSONObject(i);    		
 	       	    		jo 				= c.getJSONObject("TopStoryList");       	    		
 	       	    		
 	       	    		String vidUrlCntnt = "FALSE";
 	       	    		
     					HashMap<String, String> map = new HashMap<String, String>();
     					
         				map.put(KEY_EID, jo.getString("TopStoryID"));
  		                map.put(KEY_TITLE, stipHtml(jo.getString("Title")));
  		                map.put(KEY_ID, jo.getString("ID"));           	          	                      	          		                      	        	
          	           	map.put(KEY_IMAGE,jo.getString("TopImgSrc"));		                      	           	
		...
		adapter=new TopStoriesAdapter(getApplicationContext(), storydata);
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View view, int position, long id) {
				...
				in.putExtra("catType", "Top Stories");
				in.putExtra("name", editorlist.get(Editorchoice.KEY_TITLE));
				in.putExtra("description", stipHtml(editorlist.get(Editorchoice.KEY_DESC)));
	...
	public class TopStoriesAdapter extends BaseAdapter {
	    ...
	    public TopStoriesAdapter(Context context, ArrayList<HashMap<String, String>> mylist) {
		 	this.data = mylist;
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			   View vi=convertView;
		        ...
		        title.setText(editorlist.get(TopStories.KEY_TITLE));
		        String imageurl = editorlist.get(TopStories.KEY_IMAGE).replaceAll(" ", "%20");
